...
$lang = array_merge($lang, array(
	...
	'CONTACT_PRIVACYPOLICY_EXPLAIN'	=> 'I confirm that the given name, e-mail adress, message text and my IP-address will be processed and stored by the owner of the board according to the <a href="%s">Privacy policy</a>.',
